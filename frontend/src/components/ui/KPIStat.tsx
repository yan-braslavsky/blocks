        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <div className="flex items-center space-x-2">
              ...
              <p className={`text-sm font-medium text-slate-600 dark:text-slate-300 ${variant === 'compact' ? 'text-xs' : ''}`}>
                {label}
              </p>
            </div>
            <p className={`font-bold text-slate-900 dark:text-slate-100 mt-2 ${variant === 'compact' ? 'text-lg' : 'text-2xl'}`}>
              {value}
            </p>
            {change && (
