...
export default function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
      ...
      {/* Mobile sidebar */}
      <div
        className={`fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 z-30 transform transition-transform duration-300 ease-in-out lg:hidden ${
              ...
              <div className='bg-gray-50 dark:bg-gray-700 rounded-lg p-4'>
                ...
                {tenant.lastIngestAt && (
                  <p className='text-xs text-gray-600 dark:text-gray-400 mt-1'>
                    Last sync:{' '}
                    {new Date(tenant.lastIngestAt).toLocaleDateString()}
                  </p>
                )}
              </div>
            )}
