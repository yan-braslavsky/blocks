...
export const generateCSSCustomProperties = (
  ...
  return {
    '--color-primary':
      theme === 'dark' ? colors.primary[400] : colors.primary[500],
    '--color-secondary':
      theme === 'dark' ? colors.secondary[400] : colors.secondary[500],
    '--color-background':
      theme === 'dark' ? colors.slate[900] : colors.slate[50],
    '--color-surface': theme === 'dark' ? colors.slate[800] : '#ffffff',
    '--color-text': theme === 'dark' ? colors.slate[100] : colors.slate[900],
    '--color-text-muted':
      theme === 'dark' ? colors.slate[400] : colors.slate[600],
